...
public class SignUp extends Activity {
    ...
    public void signUp(View v) {
        ...
        if (HelpMe.isNetworkAvailable(this)) {
            ...
            Toast.makeText(this, "Network unavailable please turn on your data/WiFi", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getParams() {
        ...
        params.put("user[device_id]", Constants.DEVICE_TYPE_ANDROID);
        params.put("user[reg_id]", regid);
        Log.d(TAG, "reg id in params = " + params.toString());
    }
    ...
    private void makeRequestOnServer() {
        ...
        CustomJsonRequest signUpReg = new CustomJsonRequest(Request.Method.POST, url, params,
            ...
            public void onErrorResponse(VolleyError error) {
                pDialog.dismiss();
                Toast.makeText(SignUp.this, "Unable to Sign Up please try after some time", Toast.LENGTH_LONG).show();
